...
docker run -d --name=pweb --restart always --network=my-net --ip=172.20.0.101 -p 8888:8080 -v /root/PFC/configuracion/pweb/nginx.conf:/etc/nginx/nginx.conf nginx:latest
